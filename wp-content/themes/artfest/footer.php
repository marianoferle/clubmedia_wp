...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
      ...
      <script src="<?php bloginfo('template_url') ?>/js/materialize.min.js" type="text/javascript" charset="utf-8"></script>
      <script src="<?php bloginfo('template_url') ?>/js/app.js" type="text/javascript" charset="utf-8"></script>
